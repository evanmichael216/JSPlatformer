...
var wobbleESpeed = 8, wobbleEDist = 5;

Enemy.prototype.act = function(step) {
  this.wobble += step * wobbleSpeed;
  var wobblePos = Math.sin(this.wobble);
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  if (type == "lava" && this.status == null) {
    ...
    this.finishDelay = 1;
	deaths++;
	document.getElementById("message").innerHTML = "You Dead: " + deaths + " Time";
...
function runGame(plans, Display) {
  ...
  function startTimer(duration, display) {
    ...
    setInterval(function () {
        ...
        document.getElementById("time").innerHTML = "Play Time:" + minutes + ":" + seconds;
